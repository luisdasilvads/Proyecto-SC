...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{url('vinculo')}}">Lista de Vínculos</a></li>
                ...
                <!--<form action="{url('beneficiario/'.$beneficiario->id)}}" method="POST" enctype="multipart/form-data">-->
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            ...
                            <select name="beneficiarios" id="beneficiarios" class="form-control" disabled>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select name="oferente" id="oferente" class="form-control" disabled>
                                @foreach ($beneficiarios as $beneficiario)
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select name="forma_comunacion" id="sector" class="form-control" disabled>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input name="lugar" type="text" class="form-control" id="lugar"
                                placeholder="Ej: Caracas" disabled value="{{$vinculo->lugar}}">
                        </div>
                        <div class="form-group col-md-2">
                            ...
                            <input name="nombre_apellido_contacto" type="text" class="form-control" id="nombre_apellido_contacto"
                                placeholder="Ej: Jhon Doe" disabled value="{{$vinculo->nombre_apellido_contacto}}">
                        </div>
                        <div class="form-group col-md-2">
                            <label for="fecha" class="col-form-label">Fecha Contacto</label>
                            <input name="fecha" type="date" class="form-control" id="fecha"
                                placeholder="" disabled value="{{$vinculo->fecha}}">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="descripcion" class="col-form-label">Descripción</label>
                            <textarea class="form-control" id="descripcion" name="descripcion" rows="5" placeholder="Descripcion del vínculo..." disabled>{{$vinculo->descripcion}}</textarea>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-block btn-info waves-effect waves-light">Eliminar
                        Vínculo</button>
                </form>

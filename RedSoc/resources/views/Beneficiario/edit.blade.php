...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Editar Beneficiarios</li>
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Editar Beneficiarios</h4>
                ...
                <!--<form action="{url('beneficiario/'.$beneficiario->id)}}" method="POST" enctype="multipart/form-data">-->
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input name="nombre" type="text" class="form-control" id="nombre" placeholder="Ej: RedSoc" required value="{{$beneficiario->nombre}}">
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input name="nombre_cont" type="text" class="form-control" id="nombre_cont" placeholder="Ej: Jhon Doe" required value="{{$beneficiario->nombre_cont}}">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input name="email" type="email" class="form-control" id="email" placeholder="Ej: jhondoe@gmail.com" required value="{{$beneficiario->email}}">
                        </div>
                        
                        <div class="form-group col-md-2">
                            <label for="telf_c_cont" class="col-form-label">Teléfono Oficina</label>
                            <input name="telf_c_cont" type="text" class="form-control" id="telf_c_cont" placeholder="0212-1234567" required value="{{$beneficiario->telf_c_cont}}" >
                        </div>
                        <div class="form-group col-md-2">
                            <label for="telf_l_cont" class="col-form-label">Teléfono Celular</label>
                            <input name="telf_l_cont" type="text" class="form-control" id="telf_l_cont" placeholder="0414-1234567" required value="{{$beneficiario->telf_l_cont}}">
                        </div>
                    </div>
                    
                    <button type="submit" class="btn btn-block btn-info waves-effect waves-light">Actualizar Beneficiario</button>
                </form>

...
<html lang="en">
    <head>
        ...
        <!-- third party css -->
        <link href="{{url('DashboardAssets/libs/datatables/dataTables.bootstrap4.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{url('DashboardAssets/libs/datatables/responsive.bootstrap4.css')}}" rel="stylesheet" type="text/css" />
                ...
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="{{url('DashboardAssets/images/users/user.png')}}" alt="user-image" class="rounded-circle">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a class="mdi mdi-transit-connection-variant" href=" {{url('beneficiario')}} "> Listar</a>
                                    </li>
                                    <li>
                                        <a class="mdi mdi-link-plus" href="{{url('beneficiario/create')}}"> Agregar</a>
                                    </li>
                                </ul>
                            </li>
